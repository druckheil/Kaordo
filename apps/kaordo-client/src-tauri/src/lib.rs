...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            auth::auth_login,
            auth::auth_seed_login,
            auth::auth_issue_seed,
            auth::auth_logout,
            auth::auth_me,
            auth::auth_presence,
            auth::auth_register,
            ...
            auth::admin_ban_user,
            auth::admin_unban_user,
            auth::admin_erase_user,
            auth::admin_reset_user_seed,
            auth::fluo_bootstrap,
            auth::fluo_like_states,
            auth::fluo_node_ids,
            ...
            auth::ilo_bootstrap,
            auth::ilo_cards,
            auth::ilo_create_card,
            auth::ilo_delete_card,
            auth::ilo_delete_cards,
            auth::ilo_grade,
            auth::ilo_progress,
            auth::ilo_train_next,
            auth::ilo_update_card,
            auth::ilo_taglibro_bootstrap,
            auth::ilo_taglibro_day,
            auth::ilo_taglibro_save_plans,
            auth::ilo_taglibro_save_diary,
            auth::ilo_taglibro_save_day,
            auth::ilo_taglibro_events,
            auth::ilo_taglibro_create_event,
            auth::ilo_taglibro_update_event,
            auth::ilo_taglibro_delete_event,
            ligo_archive::ligo_open_chat_files,
            ligo_archive::ligo_prepare_playback_file,
            ligo_archive::ligo_prepare_chat_files,
            ligo_archive::ligo_write_chat_file_chunk,
            ligo_archive::ligo_write_playback_file_chunk,
            auth::nodo_delete,
            auth::nodo_access,
            auth::nodo_storage_move_upload,
            auth::nodo_prepare_storage_move,
            auth::nodo_complete_storage_move,
            auth::nodo_cancel_storage_move,
            auth::nodo_list,
