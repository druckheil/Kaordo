...
<style>
  .progress-shell { max-width: 1120px; margin: 0 auto; color: #334139; }
  header > span, .summary-grid article > span, .chart-heading span { color: var(--accent); font-size: calc(8px * var(--text-scale)); font-weight: 760; letter-spacing: .1em; text-transform: uppercase; }
  ...
  .summary-grid article { position: relative; min-width: 0; padding: 18px; overflow: hidden; background: rgb(255 255 255 / 86%); border: 1px solid #dce4df; border-radius: 15px; box-shadow: 0 10px 28px rgb(42 69 56 / 5%); }
  .summary-grid article::after { position: absolute; right: -17px; bottom: -24px; width: 78px; height: 78px; background: rgb(70 139 113 / 6%); border-radius: 50%; content: ''; }
  .summary-grid article.attention { border-color: #e2cbbd; }
  .summary-grid article.complete { border-color: #b9d6c8; }
  .summary-grid strong { display: block; margin-top: 8px; color: #2d3d34; font-size: calc(24px * var(--text-scale)); font-weight: 730; letter-spacing: -.04em; }
  .summary-grid small { display: block; margin-top: 5px; color: #8b958f; font-size: calc(8px * var(--text-scale)); }
  .charts-grid { display: grid; grid-template-columns: minmax(0, 1.1fr) minmax(360px, .9fr); gap: 13px; margin-top: 13px; }
  .charts-grid > article { padding: 21px; background: rgb(255 255 255 / 86%); border: 1px solid #dce4df; border-radius: 17px; box-shadow: 0 12px 32px rgb(42 69 56 / 5%); }
  .chart-heading { display: flex; align-items: flex-start; justify-content: space-between; gap: 16px; }
  h4 { margin: 5px 0 0; color: #34443b; font-size: calc(13px * var(--text-scale)); font-weight: 710; }
  .chart-heading > strong { color: #3c7865; font-size: calc(18px * var(--text-scale)); font-weight: 730; text-align: right; }
  .chart-heading > strong small { display: block; margin-top: 2px; color: #919b95; font-size: calc(7px * var(--text-scale)); font-weight: 650; text-transform: uppercase; }
  .week-chart { display: grid; grid-template-columns: repeat(7, minmax(30px, 1fr)); gap: 10px; height: 240px; padding: 25px 8px 0; border-bottom: 1px solid #dce3df; }
  .day-column { display: grid; grid-template-rows: 19px minmax(0, 1fr) 24px; align-items: end; min-width: 0; text-align: center; }
  .point-value { min-height: 17px; color: #547465; font-size: calc(8px * var(--text-scale)); font-weight: 700; }
  .bar-track { position: relative; width: min(28px, 70%); height: 100%; margin: 0 auto; overflow: hidden; background: linear-gradient(#f2f6f3, #e9efeb); border-radius: 8px 8px 2px 2px; }
  .bar-track i { position: absolute; right: 0; bottom: 0; left: 0; background: linear-gradient(180deg, #76ae99, #3d7b66); border-radius: 8px 8px 2px 2px; transition: height 360ms cubic-bezier(.2,.8,.2,1); }
  .day-column small { align-self: center; color: #8c9790; font-size: calc(7px * var(--text-scale)); font-weight: 660; }
  ...
  .stage-index { display: grid; width: 20px; height: 20px; color: #4c7868; background: #edf4f0; border-radius: 6px; font-size: calc(7px * var(--text-scale)); font-weight: 760; place-items: center; }
  .stage-label { color: #68766e; font-size: calc(8px * var(--text-scale)); font-weight: 650; }
  .stage-list i { height: 7px; overflow: hidden; background: #edf1ee; border-radius: 999px; }
  .stage-list i b { display: block; height: 100%; background: linear-gradient(90deg, #6ba48f, #3f7c68); border-radius: inherit; transition: width 320ms ease; }
  .stage-list > div > strong { color: #4e6056; font-size: calc(8px * var(--text-scale)); text-align: right; }
