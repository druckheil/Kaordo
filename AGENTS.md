...
- Kaordo is currently working from the scope-0.1.7 branch.
...
- 0.1.3 is the completed previous scope. 0.1.7 is the active development
...
- For the active scope 0.1.7, release/scope-0.1.7 may contain at most:
  - Kaordo_scope-0.1.7_windows_x64-setup.exe
  - Kaordo-Nodo_scope-0.1.7_android.apk
  - Kaordo_scope-0.1.7_macos_universal.dmg
...
pnpm tauri build --runner cargo-xwin --target x86_64-pc-windows-msvc \
  --bundles nsis --config '{"version":"0.1.7"}'
~~~

Copy/overwrite:

~~~text
release/scope-0.1.7/Kaordo_scope-0.1.7_windows_x64-setup.exe
~~~
...
~~~text
release/scope-0.1.7/Kaordo-Nodo_scope-0.1.7_android.apk
~~~
