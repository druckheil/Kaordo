...
- Kaordo 0.2 is released and tagged as `v0.2`; its release commit is
  ...
  and `scope-0.2.4`; active development now continues on `scope-0.2.5`.
...
- Scope 0.1.2 was the first completed fast-forward release (historical
  ...
  above.
-  0.2.4 is the current Open Beta release/download/site version. Scopes 0.1.3,
  0.1.7, 0.1.10, 0.2.1, 0.2.2, 0.2.3 and 0.2.4 are completed scopes; 0.2.5
...
- For the active scope 0.2.5, release/scope-0.2.5 may contain at most:
  - Kaordo_scope-0.2.5_windows_x64-setup.exe
  - Kaordo-Nodo_scope-0.2.5_android.apk
  - Kaordo_scope-0.2.5_macos_universal.dmg
...
pnpm tauri build --runner cargo-xwin --target x86_64-pc-windows-msvc \
  --bundles nsis --config '{"version":"0.2.5"}'
~~~

Copy/overwrite:

~~~text
release/scope-0.2.5/Kaordo_scope-0.2.5_windows_x64-setup.exe
~~~
...
~~~text
release/scope-0.2.5/Kaordo-Nodo_scope-0.2.5_android.apk
~~~
