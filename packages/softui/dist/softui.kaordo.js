...
// Kaordo integration shim: keep the upstream runtime intact while exposing
// its controller to the local Svelte adapter without a CDN global script.
if (typeof globalThis !== 'undefined') {
  globalThis.SoftUI = SoftUI;
}
